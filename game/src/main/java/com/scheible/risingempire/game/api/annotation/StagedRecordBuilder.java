...
import io.soabase.recordbuilder.core.RecordBuilder.ConcreteSettersForOptionalMode;

/**
 * @author sj
 */
@RecordBuilder.Template(options = @RecordBuilder.Options(builderMode = BuilderMode.STAGED_REQUIRED_ONLY,
		nullablePattern = "^((Initialized))$", addConcreteSettersForOptional = ConcreteSettersForOptionalMode.ENABLED,
		emptyDefaultForOptional = false, addClassRetainedGenerated = true))
